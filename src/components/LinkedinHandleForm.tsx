          ...
          <div className="flex-1">
            <div className="relative">
              <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                ...
                <span className="text-lg text-gray-600 font-outfit">linkedin.com/in/</span>
              </div>
              <input
                type="text"
                value={linkedinHandle}
                onChange={handleLinkedinChange}
                className="w-full pl-44 pr-4 py-4 text-lg text-gray-900 bg-white border-2 border-[#CFCFCF] rounded-2xl transition-all duration-200 font-outfit focus:outline-none focus:border-accent hover:border-accent placeholder-gray-400"
                maxLength={50}
                autoFocus
